...
[![Container Build and Publish](https://github.com/Gibby/k8s-wait-for/actions/workflows/container.yml/badge.svg)](https://github.com/Gibby/k8s-wait-for/actions/workflows/docker.yml)
![Container Image Size](https://img.shields.io/docker/image-size/gibby/k8s-wait-for/edge)
